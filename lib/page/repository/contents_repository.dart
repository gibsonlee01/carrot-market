...
import 'package:carrot/page/repository/local_storage_repository.dart';
class ContentRepository extends LocalStorageRepository{
  final String MyFavoriteStorekey ='MY_FAVORITE_STORE_KEY';
  ...
  Future <List<Map<String,String>>>loadContentFromLocation(String location) async{
  ...
  addMyFavoriteContent(Map<String,String> content) async{
    String? jsonString= await this.getStoredValue(MyFavoriteStorekey);
    List<dynamic>favoriteContentList = jsonDecode(jsonString!);
    favoriteContentList.add(content);
    this.storeValue(MyFavoriteStorekey,jsonEncode(favoriteContentList));
  }
